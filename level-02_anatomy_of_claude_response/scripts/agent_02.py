...
##  UNTIL THIS POINT, IT IS THE SAME AS THE PREVIOUS level-01 SCRIPT. 
##  NOW, LET'S PRINT EACH OF THE ATTRIBUTES OF THE RESPONSE AND UNDERSTAND THEIR MEANING.

print("Response ID:", message.id)  # this prints the unique identifier of the response received from the Claude model. This can be useful for tracking and referencing specific responses.
print("Response Object:", message.container)  # this prints the type of container
print("Response Citations:", message.content[0].citations)
print("Response Text:", message.content[0].text)
print("Response Model:", message.model)
print("Response Role:", message.role)
print("Response Stop_Reason:", message.stop_reason)
print("Response Stop_Details:", message.stop_details)
print("Response Stop_Sequence:", message.stop_sequence)
print("Response Type:", message.type)
print("Response Usage:", message.usage)